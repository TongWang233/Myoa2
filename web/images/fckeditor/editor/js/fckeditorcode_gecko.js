...
;FCKConfig.ProcessHiddenField = function () {
    ...
    for (var i = 0; i < B.length; i++) {
        ...
        if (D == 'CustomConfigurationsPath') FCKConfig[D] = E; else if (E.toLowerCase() == "true") this.PageConfig[D] = true; else if (E.toLowerCase() == "false") this.PageConfig[D] = false; else if (E.length > 0 && !isNaN(E)) this.PageConfig[D] = parseFloat(E); else this.PageConfig[D] = E;
    }
};
        ...
        switch (c) {
            ...
            default:
                if (!B) {
                    ...
                    if (C) this.Disable(); else this.Enable();
                    ShowScaytState();
                }
        }
        ;
...
FCKToolbarItems.GetItem = function (A) {
    ...
    switch (A) {
        ...
        case 'ShowBlocks':
            ...
            break;
        case 'SpellCheck':
            if (FCKConfig.SpellChecker == 'SCAYT') B = FCKScayt.CreateToolbarItem(); else B = new FCKToolbarButton('SpellCheck', FCKLang.SpellCheck, null, null, null, null, 13);
            break;
        default:
